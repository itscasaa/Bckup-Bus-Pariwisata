...
(6,  'Malika Wisata', 'medium_bus',  59, 3500000, 'bus6/bus6.jpeg',     'Bus medium Malika Wisata dengan kapasitas 59 kursi, armada terbaru yang nyaman untuk wisata grup. Dilengkapi AC, 1 unit LCD TV, Android Entertainment System, karaoke + microphone, Port USB, dan kompartemen bagasi atas & bawah.', '["Seat 3-2","AC","1 Unit LCD TV","Audio Set","Android Entertainment System","Karaoke + Microphone","Port USB","Kompartemen Bagasi Atas + Bawah","Lampu Baca"]'),
