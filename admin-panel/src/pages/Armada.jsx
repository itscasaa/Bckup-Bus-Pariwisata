...
export default function Armada() {
  ...
  const handleHapus = async (id, nama) => {
    ...
    setDeleting(id);
    try {
      await fetch(`${API}/admin/api/hapus_armada.php?id=${id}`);
                    ...
                    >
                      ...
                      <td className="py-4 pr-4">
                        <div className="flex items-center gap-4">
                          {/* Gambar landscape */}
                          <div
                            className="shrink-0 rounded-xl overflow-hidden bg-surface-dim"
                            style={{ width: '110px', height: '75px', minWidth: '110px' }}
                          >
                            <img
                              ...
                              onError={e => {
                                ...
                                e.target.src = 'https://placehold.co/110x75/e4e1ee/777587?text=Bus';
                              }}
                            />
                          </div>
                          <div>
