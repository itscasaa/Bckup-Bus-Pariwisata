  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.username === 'admin' && formData.password === 'admin123') {
      setTimeout(() => {
        ...
        localStorage.setItem('admin_nama', 'Administrator');
        // Navigate to "/" which renders Layout > Dashboard (index route)
    ...
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-container-lowest rounded-[24px] p-8 mb-5 text-center"
          ...
          <h1 className="font-bold text-primary mb-1" style={{ fontSize: '22px' }}>Surya Tour Trans</h1>
